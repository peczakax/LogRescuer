...
namespace io {
    ...
    // Writes footer metadata to an output stream
    void writeFooter(std::ofstream& stream, uint64_t metaOffset, uint64_t metaCount);

    // Reads footer metadata from an input stream
