...
void BrotliCompressor::compressStream(std::istream& input, std::ostream& output) {
...
size_t BrotliCompressor::decompressStream(std::istream& input, std::ostream& output) {   
