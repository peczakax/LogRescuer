...
void ZStandardCompressor::compressStream(std::istream& input, std::ostream& output) {
...
size_t ZStandardCompressor::decompressStream(std::istream& input, std::ostream& output) {
